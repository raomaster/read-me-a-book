...
if __name__ == "__main__":
    # Este bloque permite ejecutar la aplicación con 'python -m src.main'
    # desde el directorio raíz del proyecto.
    import uvicorn
    logging.info("Iniciando servidor Uvicorn desde src/main.py para ejecución con -m")
    # Usar la cadena 'src.main:app' permite que --reload funcione correctamente.
